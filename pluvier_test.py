...
#            "TKPW-PLT": "gouvernement",
    ...
    def test_lesson41_add_stl_others(self):
        self.assertSame({
            'R-FZ':'refuse',
            'R-FL/UZ':'refuse',
    ...
    def test_lesson41_add_stl_PLT_for_lement(self):
        self.assertSame({
            "WHAPLT": "finalement",
            "PROB/APLT" : "probablement",
            "PWREUFPLT": "brièvement",
            })
...
#            "WHA*EZ": "veniez",
 #           "WHAEUGS": "vinaigre",
    ...
    def test_lesson41_add_stl_start_with_en_is_en_not_an(self):
            self.assertSame({
            'EPB/WEU':'envie',
            'AFRBGS':'ancre',
            })
...
#            "SHO*PB": "champignon",
    ...
    def test_new_rule_from_josiah_umule(self):
        self.assertSame({
            "ABG/UFRPL": "accumule",
            "TUFRPLT": "tumulte",
            "STEUFRLGS": "stimulation", 
...
#            "PRAOUP": "préoccupe", 
    ...
    def test_stl_new_rule_inverse_dit_suffixe(self):
        self.assertSame({
              'KREUD':'crédit',
            'KRAPBS':'créance',
    ...
    def test_stl_new_rule_SWR_for_SURV(self):
        self.assertSame({
              'SWRAEULZ':'surveille',
            'SWREUPBS':'surveillance',
            })
...
#            "AOUP": "préoccupe", 
    ...
    def test_new_rule_FR_for_fer(self) :
        self.assertSame({
            'PREFR/*EZ': 'préférez',
            'PREFR/R*EZ': 'préférerez'
            })
 ...
 #           "AL/-TS" : "allait"
    ...
    def test_new_rule_e_ee(self):
        ...
        self.assertAllMatching("coder",[ "KOD/-R"])
        self.assertSame({
#            "KWR/-D" : "joué",
#            "ABD": "année",
            "TRET/-D" : "traité",
...
#            "AQT" : "adore",
    ...
    def test_stl_new_rule_verb_complique(self):
        self.assertSame({
#            "AQT" : "
            #'APB/PH-L/-R': "emmêler",
    ...
    def test_stl_new_rule_OE_for_eo(self):
        self.assertSame({
#            "AQT" : "adore",
            "PROEBG/UP": "préoccupe", 
            "TPHOEFL/EUT": "néophyte",
            "TOER/EU" : "théorie",
            "OFT/OE/PAEUT": "ostéopathie", 
...
#        namefunc=inspect.stack()[1][3]
        namefile=namefunc.split('_')[0]
        with open('lessons/json/'+str(namefile)+'.json', "a") as d:
            myjson=json.dumps(words, indent = 4, ensure_ascii=False )
            d.write(myjson)
        with open('lessons/typey_type/'+str(namefile)+'.type', "a") as d:
...
#            return True
    ...
    def test_verb_matching_allait(self):
        self.assertAllMatching('allait' , ['AE/HR/-S', 'AL/-S', 'HR/-S'] )

    def test_verb_matching_courait_ending(self):
    ...
    def test_nom_matching_existerai(self):
        ...
        self.assertAllMatching('existerais' , ['KPEUS/TRAEUS', 'KPEUFT/RAEUS'] ) 
    ...
    def test_nom_matching_vallee(self):
        self.assertSame({ 'WHRED': 'vallée',
                          'SK-LZ/-D': 'conseillé'}) 

    def test_nom_la_LZ_on_right_hand(self):
        self.assertSame({ "ELZ/PWORGS": "élaboration",}) 
